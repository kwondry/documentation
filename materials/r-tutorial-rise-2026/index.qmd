...
::: {.callout-tip collapse="true" title="👉 New here? Click to open the step-by-step setup instructions"}
...
<p style="text-align:center; margin-top:1.5em;"><a href="#" onclick="this.closest('.callout').querySelector('.callout-header').click(); return false;">▲ Collapse these steps</a></p>
