...
2. `/n/scratch/users/<first_letter_of_hms_id>/<hms_id>`    Scratch directory is for temporary storage and files are deleted in 45 days.    
...
```{python}
#| eval: false
cd /n/scratch/users/<first_letter_of_hms_id>/<hms_id>
```
