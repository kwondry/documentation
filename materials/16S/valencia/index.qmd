...
Then, follow the instructions on [https://github.com/ravel-lab/speciateIT/](https://github.com/ravel-lab/speciateIT/) to install. **Make note of the location where you put the speciateIT folder.** 
