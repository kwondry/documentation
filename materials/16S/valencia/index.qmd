...
To install Valencia, download the script here. This version of the script is from Michael France as of June 2024 and as of that time was the correct way to run Valencia
...
This code reads in your phyloseq object, and writes out two files:
...
Now run Valencia. The CST centroids file should be from the SpeciateIT github repository, and the Valencia python script should be downloaded from here.
