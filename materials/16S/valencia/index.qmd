...
Then, follow the instructions on [https://github.com/ravel-lab/speciateIT/](https://github.com/ravel-lab/speciateIT/) to install. **Make note of the location where you put the speciateIT folder.** When you download the database, you can just download the "V4V4" database instead of all three provided files to save time.
