...
### Prequisites
 ...
 - Ensure you have O2 access with `mamba` and `snakemake` installed. For O2 setup instructions, visit [here](../../getting-started/installation/index.qmd).
...
Launch VSCode on an O2 compute node. More instructions can be found [here](https://kwondry.github.io/documentation/materials/getting-started/installation/#setup-o2-access-with-vscode-launch-vscode-on-o2-login-node-and-create-a-passphrase-to-expedite-o2-access).
