...
Launch VSCode on an O2 compute node. More instructions can be found [here](https://kwondry.github.io/documentation/materials/getting-started/installation/#setup-o2-access-with-vscode-create-a-passphrase-to-expedite-o2-access).
