...
### Adding your samples
Download a sample sheet [here](https://github.com/kwondry/smartseq_kraken/blob/main/input/sample_sheet.csv "download"){target="_blank"} and add your samples with the corresponding filepaths. 
You can edit the raw csv in any editor you'd like and save as csv. Columns are named sample, fastq_1, fastq_2, strandedness. If sequences are single-end, leave the fastq_2 column empty.

Then, you can upload your edited sample sheet onto O2 using your **local** terminal and the following command.
```{python}
#| eval: false
